...
export const installer = (Sys.installer = function (application, progress) {
    ...
    let silentCmd = isWindows()
        ...
        : ['-y'];
    let whatToInstall = isArray(application)
    ...
    if (cmd != 'powershell') {
        if (cmd.includes('choco') && isWindows()) {
            cmd = (_a = where('choco')) !== null && _a !== void 0 ? _a : 'choco';
...
export const spawning = (Sys.spawning = function (command, argument, progressOptions, options) {
    return new Promise((resolve, reject) => {
        ...
        if (argument.includes('fake-js') &&
            ((_a = Object.getOwnPropertyDescriptor(process, 'platform')) === null || _a === void 0 ? void 0 : _a.value) ==
                'darwin') {
            spawned.kill('SIGKILL');
            return resolve('For testing only. ' + output);
        }
